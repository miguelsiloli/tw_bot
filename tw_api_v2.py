...
class tw_api(object):
    ...
    @staticmethod
    def login(username:str, password:str, gameworld: str) -> None:
    ...
    @staticmethod
    def logout(village_id:str) -> None:
    ...
    @staticmethod
    def premium_features(village_id:str) -> dict:
    ...
    @staticmethod
    def player_info(village_id: str) -> dict:
    ...
    @staticmethod
    def number_of_villages(village_id:str) -> dict:
    ...
    @staticmethod
    def incoming(village_id:str) -> list:
    ...
    @staticmethod
    def troops_available(village_id:str) -> dict:
    ...
    @staticmethod
    def attack_power(village_id:str) -> dict:
    ...
    @staticmethod
    def village_info(village_id: str) -> dict:
    ...
    @staticmethod
    def garage_queue(village_id:str) -> dict: # done
    ...
    @staticmethod
    def stable_queue(village_id:str) -> dict: # error when queue is empty
    ...
    @staticmethod
    def barracks_queue(village_id: str) -> dict: # error when queue is empty
    ...
    @staticmethod
    def construction_queue(village_id: str) -> dict: 
    ...
    @staticmethod
    def merchant_status(village_id:str) -> dict: # can be improved
    ...
    @staticmethod
    def train(village_id: str, view: str, unit:str, amount: str) -> None: # done
    ...
    @staticmethod
    def send_units(village_id: str, target_village: dict, units: dict, attack: bool = True ) -> None:
    ...
    @staticmethod
    def create_market_offer(village_id:str, sell: str, res_sell: str, buy: str, res_buy: str, offers: str, max_time: str = "8"):
    ...
    @staticmethod
    def send_resources(village_id:str, target_village: dict, wood: str = 0, stone: str = 0, iron: str = 0):
