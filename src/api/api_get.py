...
class User_Endpoint:
    ...
    def __init__(self):
        ...
        if User._instance.verify_session():
            self.session = User._instance.get_session()
        else:
            self.session = User._instance.new_session()

        self.gameworld = User._instance.gameworld
        self.village_id = User._instance.village_id
        self.csrf_token = User._instance.csrf_token
        self.session_id = User._instance.session_id
        self.time = time.time()
