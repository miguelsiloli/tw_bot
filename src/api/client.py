...
class client():
    ...
    def get(self, url: str, wait: float = 1.00, timeout: float = 5, **kwargs) -> requests.models.Response:    
    ...
    def post(self, url: str, payload: dict = None, json = None, wait: float = 1.00, timeout: float = 5, **kwargs) -> requests.models.Response:  
        """ :returns: requests.models.Response
