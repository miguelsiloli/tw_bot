...
class Vill:
    ...
    def __init__(self):
        ...
        if Vill._instance.verify_session():
            self.session = Vill._instance.get_session()
        else:
            self.session = Vill._instance.new_session()

        self.gameworld = Vill._instance.gameworld
        self.village_id = Vill._instance.village_id
        self.csrf_token = Vill._instance.csrf_token
        self.session_id = Vill._instance.session_id
        self.time = time.time()
...
#print(Vill().troops_available("40568"))
#print(Vill().village_info("40568"))
#print(Vill().garage_queue("25382"))
#print(Vill().stable_queue("25382"))
#print(Vill().barracks_queue("25382"))
#print(Vill().construction_queue("25382"))
#print(Vill().merchant_status("25382"))
#print(Vill().population("25382"))
